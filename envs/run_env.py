...
class Run(gym.Env):
    ...
    def step(self, action):
        ...
        '''compute observation'''
        pos, qpos, qvel, omega, grav, react, torq, vel, ball_pos, ball_vel, goal_pos = self.get_state()
    ...
    def get_state(self):
        ...
        return pos, qpos, qvel, omega, grav, react, torq, vel, ball_pos, ball_velocity, goal_pos
